...
do
	...
	function rw(_, text, r, g, b, _, _, _, _, _, icon)
		...
		if icon then text = "\124T"..icon..":15:15:0:0:64:64:4:60:4:60\124t "..text end
		if RaidWarningFrame.AddMessage then
			-- 12.1.0+: RaidNotice_AddMessage removed; RaidWarningFrame carries the mixin method
			RaidWarningFrame:AddMessage(text, white)
		else
